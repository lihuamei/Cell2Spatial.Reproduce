...
#cell2location.models.Cell2location.setup_anndata(adata=adata_snrna_raw,labels_key=celltype_key)
...
adata_snrna_raw = mod.export_posterior(
    adata_snrna_raw, sample_kwargs={'num_samples': 10000, 'batch_size': 2500, 'use_gpu': False}
)
